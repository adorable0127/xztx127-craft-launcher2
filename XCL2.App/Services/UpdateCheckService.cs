...
///    本次直接结束，不写任何"已忽略/跳过"的标记。当前版本为 2.2.13；下次 GitHub 发布
///    2.2.14（或更高版本）时仍会正常提示，不会被"之前拒绝过"影响。
...
///
/// ===== 为什么不做"跳过此版本" =====
/// 当前正式版是 2.2.13；下一次 GitHub Release 为 2.2.14（或更高版本）时要继续提示。
...
public static class UpdateCheckService
{
    ...
    /// <summary>程序集版本通常是 2.2.13.0，而 Release tag 是 2.2.14。提示里去掉末尾无意义的 .0，
    /// 让当前版本稳定显示为 2.2.13、下一版稳定显示为 2.2.14。</summary>
