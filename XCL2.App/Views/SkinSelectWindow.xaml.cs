...
public partial class SkinSelectWindow : OverlayDialogControl
{
    ...
    private void BrowseSkin_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Filter = Loc.T("Str_Cs_SkinSelect_PngFilter", "PNG 图片|*.png|所有文件|*.*"),
            Title = Loc.T("Str_Cs_SkinSelect_ChoosePngTitle", "选择皮肤图片(PNG)")
        };
    ...
    private void Ok_Click(object sender, RoutedEventArgs e)
    {
        ...
        else // Custom
        {
            ...
            {
                ShowError(Loc.T("Str_Cs_SkinSelect_PleaseChoosePng", "请先选择一张 PNG 皮肤图片。"));
                return;
            }
            ...
            if (_pendingSourcePngPath != null)
            {
                ...
                {
                    ShowError(Loc.F("Str_Cs_SkinSelect_SaveFailed", "保存皮肤文件失败：{0}", ex.Message));
                    return;
                }
            }
